...
CREATE TABLE `litemall_goods` (
  ...
  `is_member` tinyint(1) DEFAULT '0' COMMENT '是否购买成为会员，如果设置则可以在首页展示',
...
CREATE TABLE `litemall_order` (
  ...
  `recommender_user_id` int(11) DEFAULT NULL COMMENT '推荐人用户ID',
  `commission` decimal(16,2) DEFAULT '0.00' COMMENT '订单产生的佣金',
